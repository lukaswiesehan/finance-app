  ...
  return (
    <div className="relative sm:flex w-screen max-w-screen-2xl 2xl:mx-auto 2xl:pr-8">
      ...
      <div className="flex-grow overflow-auto">
        ...
        <main className="w-full p-4 py-8 sm:p-8 md:p-12 mb-16 sm:mb-0 sm:rounded-l-3xl 2xl:rounded-r-3xl bg-white border-t border-b sm:border-l 2xl:border-r border-gray-200 space-y-8 sm:space-y-12 md:space-y-16">
          {children}
        </main>
