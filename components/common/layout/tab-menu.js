...
export const TabMenu = ({elements}) => {
  ...
  return (
    <nav className="w-full overflow-x-scroll overflow-y-hidden border-b border-gray-200">
      <ul className="whitespace-nowrap space-x-2 sm:space-x-4 md:space-x-8  -mb-px">
